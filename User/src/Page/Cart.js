...
export default function Cart() {
  ...
  return (
    <>
        <div className='container-10 mt-5' style={{"marginTop":"10%"}}>
        ...
        : 
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-7">
                                  ...
                                  <div className="row g-0 p-3">
                                        ...
                                        <div className="col-md-2 text-success"> <h6>  50% OFF </h6></div>
            ...
            <div className='col-md-4 col-sm-12 pt-5 pl-3' style={{backgroundColor:'white'}}  > 
                ...
                <div className="d-flex bd-highlight mt-2 mb-2">
                    <div className="p-2 flex-grow-1 bd-highlight"><h4> Total Amount</h4></div>
                    <div className="p-2 bd-highlight"><h4 className='text-success'> ₹  </h4></div>
                </div>
                <hr className='m-0'/>
