          ...
          <div className='row '> 
                <div className='col-md-8 col-sm-12 p-4' style={{backgroundColor:'white'}} > 
                    <div className='row p-3 border border-1'> 
                        <div className='col-md-3 col-sm-12'><h4>My Cart ({product.length}) </h4></div> 
            ...
            <div className='col-md-4 col-sm-12 pt-5 pl-3' style={{backgroundColor:'white'}}  > 
                ...
                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight"><h5>Price (2 items)</h5></div>
                    <div class="p-2 bd-highlight"><h5>₹6,998</h5></div>
                </div>
                
                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight"><h5>Discount</h5></div>
                    <div class="p-2 bd-highlight"><h5 className='text-success'> −₹3,575</h5></div>
                </div>

                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight"><h5>Coupons for you</h5></div>
                    <div class="p-2 bd-highlight"><h5 className='text-success'> −₹120</h5></div>
                </div>
                
                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight"><h5>Delivery Charges</h5></div>
                    <div class="p-2 bd-highlight"><h5 className='text-success'> FREE</h5></div>
                </div>

                <hr className='m-0'/>
                <div class="d-flex bd-highlight mt-2 mb-2">
                    <div class="p-2 flex-grow-1 bd-highlight"><h4> Total Amount</h4></div>
                    <div class="p-2 bd-highlight"><h4 className='text-success'> ₹3,303</h4></div>
                </div>
                <hr className='m-0'/>
